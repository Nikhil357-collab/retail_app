...
if uploaded_file:
    ...
    # Convert qty_sold to numeric
    data["qty_sold"] = pd.to_numeric(data["qty_sold"], errors="coerce")
    data = data.dropna(subset=["qty_sold"])  # drop rows where qty_sold couldn't convert
